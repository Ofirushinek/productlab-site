...
const I18N = {
  he: {
    ...
    ofir_role: "ראש הצוות",
    agents: [
      { img: "agent-cto", role: "AI CTO", b: "אחראי על הבסיס הטכני, ולוקח רעיון גולמי והופך אותו למשהו שבאמת רץ." },
      { img: "agent-cpo", role: "AI CPO", b: "אחראי על המוצר, ומחליט מה שווה לבנות וממה לוותר." },
      { img: "agent-pd", role: "מעצב מוצר AI", b: "אחראי על הקראפט, וגורם לכל החלטה להיראות ולהרגיש נכון עד הפרט האחרון." },
    ],
  ...
  en: {
    ...
    agents: [
      { img: "agent-cto", role: "AI CTO", b: "Owns the technical foundation, and turns a rough idea into something that actually runs." },
      { img: "agent-cpo", role: "AI CPO", b: "Owns the product calls, and decides what's worth building and what to cut." },
      { img: "agent-pd", role: "AI Product Designer", b: "Owns the craft, and makes every decision look and feel right down to the last detail." },
    ],
