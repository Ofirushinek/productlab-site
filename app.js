...
const I18N = {
  he: {
    ...
    hero_title_a: "להפוך לצוות של אחד. לבנות עם צוות של ",
    hero_title_mark: "סוכני AI",
    hero_title_b: ".",
    hero_sub: "ב-3 שעות תקימו צוות סוכני AI משלכם עם Claude, ותתחילו לבנות, בזמן אמת.",
  ...
  en: {
    ...
    hero_title_a: "Become a team of one. Build with a team of ",
    hero_title_mark: "AI agents",
    hero_title_b: ".",
    hero_sub: "In 3 hours, create your own AI agent team with Claude and start building, live.",
