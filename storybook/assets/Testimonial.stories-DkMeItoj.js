import{n as e,t}from"./_icons-BFdY0ZHI.js";import{t as n}from"./rolldown-runtime-Dh6celcD.js";var r,i,a,o,s,c;function l(){return(l=n((()=>{e(),r={title:`Components/Testimonial`},i=({img:e,name:n,role:r,quote:i,li:a})=>`<figure class="quote-card">
     ...
     </div></div>`},s={name:`Without LinkedIn badge`,render:()=>`<div class="sb-pad"><div class="quote-grid" style="max-width:520px;margin:auto">${i({img:`testimonial-ella`,name:`Ella Cohen`,role:`Lead Product Designer`,quote:`A fallback state: no LinkedIn link, so no corner badge.`})}</div></div>`},c=[`Single`,`Pair`,`NoLinkedIn`]})))()}l();export{s as NoLinkedIn,o as Pair,a as Single,c as __namedExportsOrder,r as default};