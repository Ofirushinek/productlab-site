...
story documents the static component + the five tools. DS tokens only.`}}}},n={figma:`<svg viewBox="0 0 38 57" aria-hidden="true">
      ...
      <rect x="8" y="17" width="5.5" height="1.4" rx=".7" fill="#fff"/></svg>`,lovable:`<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="#FF4D67" d="M12 21s-6.9-4.3-9.3-8.4C1 9.4 2.6 6 6 6c2 0 3.2 1.2 4 2.3C10.8 7.2 12 6 14 6c3.4 0 5 3.4 3.3 6.6C18.9 16.7 12 21 12 21z"/></svg>`,gemini:`<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="#6C7BF0" d="M12 2c.4 5.2 4.8 9.6 10 10-5.2.4-9.6 4.8-10 10-.4-5.2-4.8-9.6-10-10 5.2-.4 9.6-4.8 10-10z"/></svg>`},r={figma:`#F24E1E`,claude:`#CC785C`,gdocs:`#4285F4`,lovable:`#FF4D67`,gemini:`#6C7BF0`},i=`<svg class="pcursor__arrow" viewBox="0 0 24 24" width="22" height="22"><path d="M5 2.5 5 20.5 9.7 16 12.7 22.5 15.5 21.2 12.5 14.8 19 14.8Z"/></svg>`,a=e=>`<span class="pcursor" data-tool="${e}" style="position:relative;display:inline-block;--pc:${r[e]}">
