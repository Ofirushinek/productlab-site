   ...
   ${d(e,t)}`,p=e=>{let t=o[e];return`<div class="sb-pad" dir="${e===`he`?`rtl`:`ltr`}" style="max-width:980px;margin:auto">
    ...
    <div class="roster" style="margin-top:1.5rem"><div class="roster__scroll">
      <table class="roster__table roster__table--crm">
        ...
        <tbody>${[{name:`Dana Levi`,email:`dana.levi@example.com`,state:`pending`,signedIn:!1,stage:`call_booked`,source:`LinkedIn DM`,next:`Intro call tomorrow 12:00`,notes:`Interested; wants to understand where it fits her. Booked a call.`,open:!0},{name:`Omer Bar`,email:`omer.bar@example.com`,state:`confirmed`,signedIn:!0,stage:`interested`,source:`LinkedIn DM`,next:`Awaiting reply to schedule a call`,phone:`0500000000`,notes:`Reviewed the syllabus, looks great for beginners.`},{name:`Noa Shani`,email:``,state:`pending`,signedIn:!1,stage:`call_booked`,source:`WhatsApp`,next:`Intro call tomorrow ~14:00`,notes:`Content person, boutique studio. Name-only lead (no email yet).`},{name:`Curious Person`,email:`crasher@example.com`,state:`uninvited`,signedIn:!0,stage:`dropped`,source:``,next:``}].map(e=>f(t,e)).join(``)}</tbody>
      </table>
    </div></div>
  </div>`},m={render:()=>p(`en`)},h={name:`Hebrew (RTL)`,render:()=>p(`he`)},g=[`English`,`Hebrew`]})))()}_();export{m as English,h as Hebrew,g as __namedExportsOrder,t as default};