...
story documents the static component + the five tools. DS tokens only.`}}}},n={figma:`<svg viewBox="0 0 38 57" aria-hidden="true">
      ...
      <path fill="#a259ff" d="M0 28.5A9.5 9.5 0 0 0 9.5 38H19V19H9.5A9.5 9.5 0 0 0 0 28.5z"/></svg>`,claude:`<svg viewBox="0 0 24 24" aria-hidden="true" fill="#CC785C"><path d="M12 2.2c.55 2.9 1.2 4.2 3.05 4.2 0 0-2.1 1.15-2.1 1.15L18 4.35l-3.4 4.6 5.55-2.1-5 3.3 5.85.05-5.85.9 4.9 3.2-5.4-2.35 3 5.05-3.85-4.05.55 5.85-1.9-5.55-1.9 5.55.55-5.85-3.85 4.05 3-5.05-5.4 2.35 4.9-3.2-5.85-.9 5.85-.05-5-3.3 5.55 2.1L4 4.35l5.05 3.2L5.65 2.95 9.7 6.4C11.55 6.4 11.45 5.1 12 2.2z"/></svg>`,gdocs:`<svg viewBox="0 0 24 24" aria-hidden="true">
      ...
      <rect x="7.3" y="17" width="6.4" height="1.3" rx=".65" fill="#fff"/></svg>`,lovable:`<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="#FF4D67" d="M12 21s-6.9-4.3-9.3-8.4C1 9.4 2.6 6 6 6c2 0 3.2 1.2 4 2.3C10.8 7.2 12 6 14 6c3.4 0 5 3.4 3.3 6.6C18.9 16.7 12 21 12 21z"/></svg>`,gemini:`<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="#6C7BF0" d="M12 2c.5 4.6 3.4 7.5 8 8-4.6.5-7.5 3.4-8 8-.5-4.6-3.4-7.5-8-8 4.6-.5 7.5-3.4 8-8z"/></svg>`},r={figma:`#F24E1E`,claude:`#CC785C`,gdocs:`#4285F4`,lovable:`#FF4D67`,gemini:`#6C7BF0`},i=`<svg class="pcursor__arrow" viewBox="0 0 24 24" width="22" height="22"><path d="M5 2.5 5 20.5 9.7 16 12.7 22.5 15.5 21.2 12.5 14.8 19 14.8Z"/></svg>`,a=e=>`<span class="pcursor" data-tool="${e}" style="position:relative;display:inline-block;--pc:${r[e]}">
